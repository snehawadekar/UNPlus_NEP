...
def get_input_query():
    ...
    #Q17
    #reveal_globals.query1 = "Select  AVG(l_extendedprice) as avgTOTAL From  lineitem, part Where  p_partkey = l_partkey and p_brand = 'Brand#52' and  l_shipdate <> '1994-05-29';"
    #Q18
